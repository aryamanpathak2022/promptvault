  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <path d="M10.9 5.1L9 9l-3.9 1.9L7 7l3.9-1.9Z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
...
function UserAvatar({ user }: { user: User }) {
  ...
  return (
    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#F59E0B] text-xs font-semibold text-[#080808]">
...
export default function DashboardSidebar({ user }: { user: User }) {
  ...
  return (
    <>
      <div className="border-b border-[#171717] bg-[#0c0c0c] px-4 py-3 md:hidden">
        <div className="flex items-center justify-between gap-3">
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#111111] text-[#F59E0B]">
          ...
          <button
            ...
            className="rounded-lg border border-[#222222] px-2.5 py-1.5 text-xs font-medium text-zinc-300 transition-colors hover:text-zinc-50"
          >
            Sign out
          </button>
        </div>
      ...
      <aside className="hidden min-h-screen w-64 shrink-0 border-r border-[#171717] bg-[#0c0c0c] md:flex md:flex-col">
        <div className="border-b border-[#171717] px-5 py-4">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">Clean prompt versioning</p>
            </div>
          </Link>
        </div>
        ...
        <div className="border-t border-[#171717] p-3">
          <div className="rounded-xl border border-[#1d1d1d] bg-[#101010] p-3">
            ...
            <button
              onClick={() => signOut({ callbackUrl: '/' })}
              className="mt-3 w-full rounded-lg border border-[#222222] px-3 py-2 text-left text-xs font-medium text-zinc-300 transition-colors hover:bg-[#131313] hover:text-zinc-50"
            >
              Sign out
            </button>
          </div>
